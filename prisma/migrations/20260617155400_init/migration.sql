...
-- AddForeignKey
ALTER TABLE "ChannelSettings" ADD CONSTRAINT "ChannelSettings_guildId_fkey" FOREIGN KEY ("guildId") REFERENCES "GuildSettings"("guildId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GuildUserSettings" ADD CONSTRAINT "GuildUserSettings_guildId_fkey" FOREIGN KEY ("guildId") REFERENCES "GuildSettings"("guildId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EchoMessage" ADD CONSTRAINT "EchoMessage_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "EchoChannel"("channelId") ON DELETE RESTRICT ON UPDATE CASCADE;
